...
public class StaticServiceImpl implements StaticService, ServletContextAware {
	...
	public int build(String templatePath, String staticPath, Map<String, Object> model) {
		...
		try {
			...
			System.out.println("StaticServiceImpl is:"+servletContext.getRealPath(staticPath));
	...
	public int buildIndex() {
		...
		System.out.println("staticServiceImpl:"+template.getTemplatePath()+"  "+template.getStaticPath());
